...
2. Release Please bot secara otomatis membuat atau meng-update **Release PR** draf (contoh: `chore: release 1.7.0`).
...
4. Ketika Release PR tersebut di-merge:
   - Tag rilis resmi (misal `v1.7.0`) terbit di GitHub Releases.
   - File `pyproject.toml` ter-update otomatis.
